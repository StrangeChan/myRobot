...
void hctl2020_init(void)
{
	...
	GPIO_InitStructure.GPIO_Pin = GPIO_Pin_10|GPIO_Pin_11|GPIO_Pin_12; //10-SEL,11-OE,12-RST  解码器0
	...
	GPIO_InitStructure.GPIO_Pin = GPIO_Pin_6;//解码器1   RST
	...
	GPIO_InitStructure.GPIO_Pin = GPIO_Pin_10|GPIO_Pin_11|GPIO_Pin_13|GPIO_Pin_14|GPIO_Pin_15; //10-SEL,11-OE,12-RST  解码器1  13-SEL,14-OE,15-RST  解码器2
	GPIO_InitStructure.GPIO_Mode = GPIO_Mode_OUT;
	GPIO_InitStructure.GPIO_OType = GPIO_OType_PP;//推挽输出
	GPIO_InitStructure.GPIO_Speed = GPIO_Speed_100MHz;//100M
	GPIO_InitStructure.GPIO_PuPd =  GPIO_PuPd_UP;//上拉
